            ...
            <div class="footer-bar">
                <?php foreach($options['footer_bar_icon'] as $i => $fb){ if($fb){
                    ...
                    <div class="fb-item"<?php echo $bg;?>>
                        <?php
                        if($type=='0' || $type=='1'){ ?>
                            <a <?php echo WPCOM::url($options['footer_bar_url'][$i]);?><?php if($type=='1'){ echo ' class="j-footer-bar-qrcode"';} echo $color;?>>
                        ...
                        <?php }else if($type=='2'){ ?>
                            <a href="javascript:;" class="j-footer-bar-copy" <?php echo $color;?>>
                                <script type="text/tpl"><?php echo sanitize_textarea_field($options['footer_bar_url'][$i]);?></script>
                                <?php WPCOM::icon($fb, true, 'fb-item-icon');?>
                                <span><?php echo $options['footer_bar_title'][$i];?></span>
                            </a>
                        <?php } ?>
