...
class WPCOM_Module_default_slider extends WPCOM_Module{
    function __construct(){
        ...
        parent::__construct( 'default-slider', '图片滑块', $options, 'slideshow' );
    }
    ...
    function template($atts, $depth){
        ...
        <div class="swiper-container swiper-el">
                ...
                <?php if(is_array($slides) && !empty($slides)){
                    ...
                    <div class="swiper-slide">
                        <?php if(isset($slide['url']) && $slide['url']){ ?>
                            <a <?php echo WPCOM::url($slide['url']);?>><img src="<?php echo wp_get_attachment_url($slide['image']);?>" alt="<?php echo esc_attr($slides['title']);?>"></a>
                        <?php }else{ ?>
                            <img src="<?php echo wp_get_attachment_url($slide['image']);?>" alt="<?php echo esc_attr($slide['title']);?>">
                        <?php }
            ...
            <?php if($this->value('navigation', 1)){ ?><div class="swiper-button-prev"><?php WPCOM::icon('arrow-left-3');?></div>
            <div class="swiper-button-next"><?php WPCOM::icon('arrow-right-3');?></div><?php } ?>
        </div>
...
register_module( 'WPCOM_Module_default_slider' );