...
class WPCOM_Module_image_posts extends WPCOM_Module {
    function __construct() {
        ...
        parent::__construct( 'image-posts', '图文列表', $options, 'subtitles', '/module/mod-image-posts.png' );
    }
    function style( $atts ){
        return array(
            'color' => array(
    ...
    function template( $atts, $depth ){
        ...
        <div class="module-tab-wrap j-tabs-wrap active">
            <ul class="post-loop post-loop-image-news cols-<?php echo $cols;?>">
                <?php
                $args = array(
                ...
                foreach ( $news as $post ) : setup_postdata( $post );
                    get_template_part( 'templates/loop' , 'image-news' );
...
register_module( 'WPCOM_Module_image_posts' );