...
class WPCOM_Session{
    ...
    public static function session_prefix(){
        $_session_prefix = isset($_COOKIE['session_prefix']) ? sanitize_text_field($_COOKIE['session_prefix']) : '';
        ...
        $session_prefix = sanitize_text_field($session_prefix);
        if( $session_prefix == '' ) {
            $ip = 'none';
            ...
            if($_session_prefix) $session_prefix = $_session_prefix;
