...
class WPCOM_post_hot_widget extends WPCOM_Widget {
...
// register widget
function register_wpcom_post_hot_widget() {
    register_widget( 'WPCOM_post_hot_widget' );
}
add_action( 'widgets_init', 'register_wpcom_post_hot_widget' );